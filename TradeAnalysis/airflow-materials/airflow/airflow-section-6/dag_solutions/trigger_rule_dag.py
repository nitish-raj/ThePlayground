...
with DAG(
    ...
    process_task = PythonOperator(
        task_id="process", python_callable=process, trigger_rule="one_success"
    )

    notif_a_task = PythonOperator(
        task_id="notif_a", python_callable=notif_a, trigger_rule="none_failed"
    )

    notif_b_task = PythonOperator(
        task_id="notif_b", python_callable=notif_b, trigger_rule="one_failed"
    )
